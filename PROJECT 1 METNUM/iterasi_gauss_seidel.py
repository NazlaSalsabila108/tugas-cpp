...
def gauss_seidel_iteration(A, b, x0, tol=1e-6, max_iter=100):
    """
    ...
    print("Langkah-langkah Iterasi Gauss-Seidel:")
...
def main():
    print("Sistem Persamaan Linear - Metode Iterasi Gauss-Seidel")
    print("===================================================")
    ...
    solusi, iterasi = gauss_seidel_iteration(A, b, x0, tol=tol, max_iter=max_iter)
    
    print("\nSolusi sistem persamaan linear:")
    tampilkan_vektor(solusi, nama="x")
    print(f"Jumlah iterasi yang dilakukan: {iterasi}")
