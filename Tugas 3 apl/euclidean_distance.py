...
# studi kasus menghitung jarak terdekat dari gedung ke sebuah toko
# algoritmanya menggunakan Euclidean distance 
...
def main():
    ...
    distance_to_a = euclidean_distance(toko, gudang_a)
    distance_to_b = euclidean_distance(toko, gudang_b)
